...
static void ttf_antialias(size_t height, const unsigned char *indices)
{
	static const unsigned char scale3x_and_average[512] = {
		...
		,
		...
		0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x40, 0x60, 0x00, 0x00, 0x40, 0x60, 0x00, 0x00,
		0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0,
		0xA0, 0xC0, 0xE0, 0xE0, 0xA0, 0xC0, 0xE0, 0xE0,
		0x20, 0x20, 0x00, 0x00, 0x40, 0x40, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x80, 0x80, 0xE0, 0xE0, 0xA0, 0xA0, 0xE0, 0xE0,
		0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0,
	...
	unsigned side = (unsigned)(height != 0 ? height - 1 : 0);
	unsigned p, x, y;

	for (y = 1; y < side; y++) {
		unsigned char *row0 = &ttf_bitmap[(y - 1) * height];
		unsigned char *row1 = &ttf_bitmap[(y + 0) * height];
		unsigned char *row2 = &ttf_bitmap[(y + 1) * height];

		for (x = 1; x < side; x++) {
			unsigned p0 = (row0[x - 1] & 1u) << 8;
			unsigned p1 = (row0[x + 0] & 1u) << 7;
			unsigned p2 = (row0[x + 1] & 1u) << 6;

			unsigned p3 = (row1[x - 1] & 1u) << 5;
			unsigned p4 = (row1[x + 0] & 1u) << 4;
			unsigned p5 = (row1[x + 1] & 1u) << 3;

			unsigned p6 = (row2[x - 1] & 1u) << 2;
			unsigned p7 = (row2[x + 0] & 1u) << 1;
			unsigned p8 = (row2[x + 1] & 1u);

			p = p0 | p1 | p2 | p3 | p4 | p5 | p6 | p7 | p8;
			p = scale3x_and_average[p];

			row1[x] = (unsigned char)((unsigned)row1[x] | p);
		}
	}
...
void gui_print(const char *format, ...)
{
	...
	for (i = 0; i < ret; i++) {
		...
		ttf_antialias(ttf_height, &ttf_colors[0]);
