...
DANCY_CPPFLAGS=-I./common -I./include -I./include/acpica $(DANCY_VERSION)
...
ACPICA_CPPFLAGS_32=$(DANCY_CPPFLAGS) -DDANCY_32
ACPICA_CPPFLAGS_64=$(DANCY_CPPFLAGS) -DDANCY_64
