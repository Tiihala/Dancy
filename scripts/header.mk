...
DANCY_CPPFLAGS=-I. -I./include $(DANCY_VERSION) -DDANCY_SYSTEM
...
ACPICA_CPPFLAGS_32=-I./include/acpica $(DANCY_CPPFLAGS_32)
ACPICA_CPPFLAGS_64=-I./include/acpica $(DANCY_CPPFLAGS_64)
ACPICA_CFLAGS_32=-march=i686 $(DANCY_SYSTEM_CFLAGS)
ACPICA_CFLAGS_64=-march=x86-64 $(DANCY_SYSTEM_CFLAGS)

ARCTIC_CPPFLAGS_32=-I./arctic/include $(DANCY_VERSION) -DDANCY_32
ARCTIC_CPPFLAGS_64=-I./arctic/include $(DANCY_VERSION) -DDANCY_64
