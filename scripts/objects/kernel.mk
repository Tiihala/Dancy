...
./o32/base/idt_user.o: ./kernel/base/idt_user.c $(DANCY_DEPS)
...
./o32/vfs/devfs.o: ./kernel/vfs/devfs.c $(DANCY_DEPS)
...
./o64/base/idt_user.o: ./kernel/base/idt_user.c $(DANCY_DEPS)
...
./o64/vfs/devfs.o: ./kernel/vfs/devfs.c $(DANCY_DEPS)
